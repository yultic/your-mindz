...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] py-24 sm:py-32 lg:py-48 px-4 sm:px-6 lg:px-8 bg-foreground text-brand-pink overflow-hidden flex items-center justify-center">
      <Image
        src="/brain_22.png"
        alt=""
        width={700}
        ...
        aria-hidden="true"
      />
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center justify-center px-4 pt-20 sm:pt-0">
        <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold mb-6 leading-tight text-brand-violet break-words hyphens-auto">
          Psychotherapie bis 21 J.<br />
          <span className="text-brand-pink"> & Elternberatung</span>
        </h1>
